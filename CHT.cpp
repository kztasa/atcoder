...
//ax+bがたくさんある時のあるxでの最大値、最小値を(logn)で求める
//is_Minをtrueにすると最小値、false にすると最大値を求める.
//add(a, b): 直線ax+bを追加する.ただしaは広義単調増加または広義単調減少
//query(x):ax+bの最小値を求める.
//query_monotone_inc(x):ax+bの最小値を求める.ただしxは広義単調増加.
//query_monotone_dec(x):ax+bの最小値を求める.ただしxは広義単調減少.
